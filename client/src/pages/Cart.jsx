...
//   // Cart totals
//   const subtotal = cartWithTotals.reduce((sum, item) => sum + item.itemSubtotal, 0);
//   const totalGST = cartWithTotals.reduce((sum, item) => sum + item.itemGST, 0);
//   const totalUnits = cartWithTotals.reduce((sum, item) => sum + item.quantity, 0);
...
//         <h2 className="text-4xl font-bold mb-8 bg-gradient-to-r from-orange-400 to-rose-400 bg-clip-text text-transparent">
//           Your Cart
//         </h2>
...
//                     className="w-full bg-gradient-to-r from-orange-500 to-rose-600 text-white py-2 rounded-xl font-bold mt-4"
//                   >
//                     Remove From Cart 🛒
//                   </button>
//                 </div>
...
//                       className="w-full bg-slate-700/50 text-white py-3 rounded-xl"
//                     >
//                       📱 UPI
//                     </button> */}
//                      <button
...
//                       className="w-full bg-slate-600/50 py-2 rounded-xl"
//                     >
//                       ← Back to Cart
//                     </button>
...
const Cart = () => {
  ...
  const { cart = [], currency = "₹", removeFromCart, updateQuantity } = context;
